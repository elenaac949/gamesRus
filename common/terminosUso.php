...
<body>
    ...
    <main class="container">
        ...
        <p>Al crear una cuenta con nosotros, nos autorizas a recopilar y procesar ciertos datos personales con los siguientes fines:</p>

        <ul>
            <li><strong>1. Administrar tu cuenta</strong> y brindarte acceso a todas las funciones de GamesRus.</li>
            <li><strong>2. Personalizar tu experiencia</strong>, recomendándote juegos y contenido basado en tus preferencias.</li>
            <li><strong>3. Mantenerte informado</strong> sobre actualizaciones, promociones y eventos exclusivos de GamesRus (solo si decides suscribirte a nuestras comunicaciones).</li>
            <li><strong>4. Mejorar nuestro servicio</strong>, analizando tendencias y optimizando la plataforma para ti.</li>
            <li><strong>5. Garantizar la seguridad</strong>, protegiéndote contra fraudes y accesos no autorizados.</li>
        </ul>

        <p><strong>Tu privacidad es nuestra prioridad.</strong> Nunca compartiremos tus datos con terceros sin tu consentimiento, excepto cuando sea necesario por ley o para el funcionamiento de la plataforma (por ejemplo, procesadores de pago seguros).</p>

        <p>Si en algún momento quieres acceder, modificar o eliminar tus datos, puedes hacerlo desde la configuración de tu cuenta o escribiéndonos a <a href="mailto:contacto@gamesrus.com">contacto@gamesrus.com</a>.</p>

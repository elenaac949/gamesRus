...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-01-2025 a las 19:46:11
...
INSERT INTO `sistema` (`idSistema`, `nombre`) VALUES
(1, 'DOS'),
(2, 'PlayStation'),
(3, 'PlayStation 2'),
(4, 'DOS'),
...
--
ALTER TABLE `juegosistema`
  MODIFY `idJuegoSistema` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
